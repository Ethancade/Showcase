      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          <div
            ...
            before:w-full before:max-w-[400px] md:before:max-w-[600px] before:h-full before:border-2 before:border-grey-blue before:z-[-1]"
          >
            <img
              alt="profile"
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-6xl font-playfair z-10 text-center md:text-start">
            Ethan {""}
            <span
              className="xs:relative xs:text xs:font-semibold z-20"
            >
              Campbell
            </span>
          </p>
        ...
        >
          <AnchorLink
            className="bg-grey-blue text-blue3 rounded-sm py-3 px-7 font-semibold
          ...
          <AnchorLink
            className="rounded-r-sm bg-gradient-blues py-0.5 pr-0.5"
            onClick={() => setSelectedPage("contact")}
            href="#contact"
          >
